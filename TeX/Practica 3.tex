...
{\color{incolor}In [{\color{incolor}1}]:} \PY{k+kn}{import}  \PY{n+nn}{sys}
        ...
        \PY{k+kn}{import} \PY{n+nn}{pdesolver}
\end{Verbatim}
Se puede encontrar un repositorio del proyecto \href{https://github.com/ekiMGlz/PDEMethods}{aqui}.
...
Notamos que (\ref{eq:2}) nos da las condiciones iniciales para \(x\),
mientras que para \(t\) tenemos condiciones de frontera (\ref{eq:3})
Dirichlet en la izquierda y (\ref{eq:4}) Neumann por la derecha. Ademas,
sabemos que la solucion exacta es:
...
Entonces podemos escribir nuestro problema como:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} \PY{n}{u} \PY{o}{=} \PY{k}{lambda} \PY{n}{x}\PY{p}{,} \PY{n}{t}\PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{*}\PY{n}{t}\PY{p}{)}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{sin}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{*}\PY{n}{x}\PY{p}{)}
        \PY{n}{eq}\PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
        \PY{n}{eq}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{D}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{1}\PY{o}{/}\PY{n}{np}\PY{o}{.}\PY{n}{pi}
        \PY{n}{eq}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ic}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k}{lambda} \PY{n}{x} \PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{sin}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{*}\PY{n}{x}\PY{p}{)}
        \PY{n}{eq}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{bcL}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k}{lambda} \PY{n}{t} \PY{p}{:} \PY{l+m+mi}{0}
        \PY{n}{eq}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{bcR}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k}{lambda} \PY{n}{t} \PY{p}{:} \PY{o}{\PYZhy{}}\PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{*}\PY{n}{t}\PY{p}{)}
        \PY{n}{Ix} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}
        \PY{n}{It} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}
\end{Verbatim}
...
maximo de los errores al tiempo \(T = 1\):
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{n}{M} \PY{o}{=} \PY{l+m+mi}{20}
        \PY{n}{N} \PY{o}{=} \PY{l+m+mi}{256}
        
        \PY{n}{W}\PY{p}{,} \PY{n}{X}\PY{p}{,} \PY{n}{T} \PY{o}{=} \PY{n}{pdesolver}\PY{o}{.}\PY{n}{explicitHeat}\PY{p}{(}\PY{n}{eq}\PY{p}{,} \PY{n}{Ix}\PY{p}{,} \PY{n}{It}\PY{p}{,} \PY{n}{M}\PY{p}{,} \PY{n}{N}\PY{p}{)}
        \PY{n}{U} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{u}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{t}\PY{p}{)} \PY{k}{for} \PY{n}{t} \PY{o+ow}{in} \PY{n}{T}\PY{p}{]} \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n}{X}\PY{p}{]}\PY{p}{)}
        \PY{n}{Error} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n+nb}{abs}\PY{p}{(}\PY{n}{U}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{256}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{W}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{256}\PY{p}{]}\PY{p}{)}\PY{p}{)}
\end{Verbatim}

\begin{center}
Maximo Error en $T=1$: 0.00128585109347
\end{center}
    

    Finalmente, veamos como se ven graficamente la solucion exacta, asi como
la aproximada:


    \begin{center}
    \includegraphics{fig1_1.png}
    \end{center}


    \begin{center}
    \includegraphics{fig1_2.png}
    \end{center}
    
    \section*{Ejercicio 2}
    Dado el PVIF (\ref{eq:1}) planteado anteriormente, veamos el
comportamiento del metodo implicito para su aproximacion. Primero observemos una grafica de la aproximacion usando 20 pasos en el espacio (\(h = 1/20\)) y 10 pasos en el tiempo (\(k = 1/10\)):

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} \PY{n}{M} \PY{o}{=} \PY{l+m+mi}{20}
        \PY{n}{N} \PY{o}{=} \PY{l+m+mi}{10}        
        \PY{n}{W}\PY{p}{,} \PY{n}{X}\PY{p}{,} \PY{n}{T} \PY{o}{=} \PY{n}{pdesolver}\PY{o}{.}\PY{n}{implicitHeat}\PY{p}{(}\PY{n}{eq}\PY{p}{,} \PY{n}{Ix}\PY{p}{,} \PY{n}{It}\PY{p}{,} \PY{n}{M}\PY{p}{,} \PY{n}{N}\PY{p}{)}
\end{Verbatim}
